...
const pl = {
  ...
  visdomTour: {
    meta: {
      ...
      description:
        'Konferencje, roundtable i jedna sesja online, od Zurychu i Berlina po Nowy Jork i Austin. Spotkajcie inżynierów, którzy budują AI-Native SDLC z zespołami enterprise.',
      ogImageAlt:
        'Visdom on Tour 2026: mapa świata z przystankami, od Brugg-Windisch i Zurychu po Nowy Jork i Austin',
    },
  ...
  cta: {
    ...
    form: {
      ...
      sending: 'Wysyłam...',
      successTitle: 'Dzięki.',
      success: 'Inżynier odpowie w ciągu jednego dnia roboczego, a potwierdzenie jest już w drodze na wasz e-mail.',
      successAgain: 'Wyślijcie kolejne zgłoszenie',
      error: 'Nie udało się wysłać. Spróbujcie ponownie albo napiszcie na visdom@virtuslab.com.',
      errorRef: 'Numer zgłoszenia:',
      errorFallback: 'Napiszcie na visdom@virtuslab.com',
