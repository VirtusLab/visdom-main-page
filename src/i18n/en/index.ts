...
const en = {
  ...
  architecture: {
    ...
    diagram: {
      ...
      sandbox: ['Sandcat', 'sandbox'] as [string, string],
  ...
  solutions: {
    ...
    security: {
      ...
      diagramAria:
        'Sandcat runs the agent in an isolated sandbox; only approved traffic crosses the egress wall, so data stays contained and production is unreachable',
      caption: 'Two layers, one protection model.',
      sandcatHead: 'Sandcat · runtime containment',
      agentTag: 'Agent',
